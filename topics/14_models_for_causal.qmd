...
> Here are slides on [outcome modeling](../slides/lec14_causal_outcome_model/lec14_causal_outcome_model.pdf) and [treatment modeling](../slides/ipw/ipw.pdf). In Winter 2026, I plan to cover only the outcome modeling part (in order to have time for causal inference with unmeasured confounding).
