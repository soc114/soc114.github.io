...
6. Estimate a logistic regression model to predict `at_work` as a function of `sex` and `child_age`. You can use any functional form you want. Store it in an object `logistic_regression`.
