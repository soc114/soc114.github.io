...
\node[anchor = north, font = \Large, align = left] at (.5,.5) {Causal inference by outcome modeling};
\end{tikzpicture}
\end{frame}
...
\begin{frame}{Strategy: Adjust for measured confounders} \pause
...
\begin{frame}{Strategy: Adjust for measured confounders}
