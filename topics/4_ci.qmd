...
> Here are slides in [website](../slides/lec04_bootstrap/lec04_bootstrap.qmd) and [pdf](../slides/lec04_bootstrap/lec04_bootstrap.pdf) format. This page goes beyond the content of the slides and is more detailed and mathematical than the slides. Slides provide more support for coding. Notation and ideas on this page loosely draw on [Efron \& Hastie (2016)](https://hastie.su.domains/CASI/) Ch 10--11.
...
Note: In class we will use [many_samples.csv](../data/many_samples.csv). This note is just here so that the data will exist on this page.
