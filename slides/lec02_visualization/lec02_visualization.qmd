...
## Does inequality make people better off?

An argument that it does:

1. unequal rewards motivate work and innovation
2. work and innovation make everyone better off

An empirical prediction from that argument:

* Countries with higher income inequality will have higher economic output
...
\node<2> at (0,0) {\includegraphics[width = \textwidth]{figures/us2022_hh_dist_median}};
\node<3> at (0,0) {\includegraphics[width = \textwidth]{figures/us2022_hh_dist_9010}};
\end{tikzpicture}
