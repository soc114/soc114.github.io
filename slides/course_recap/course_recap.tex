...
\begin{itemize}
\item visualize economic inequality
\item connect theories to quantitative evidence
\item evaluate the effects interventions
\item conduct data analysis using R
\end{itemize}
\end{frame}}
...
\begin{frame}{We learned to ask quantitative questions}

\begin{itemize}
\item Define a population of units
\item Outcome for every unit
...
\includegraphics[width = \textwidth]{figures/summary_statistic}

\end{frame}

\begin{frame}{We learned how to make a visualization in R}

\begin{itemize}
\item Call to ggplot()
\item Adding layers
\item Customizing axis labels
\end{itemize}
...
\includegraphics[width = \textwidth]{figures/visualization}

\end{frame}

\begin{frame}{We learned about population sampling}
\centering
\scalebox{.8}{
...
\begin{frame}{We learned to define and identify causal effects}

\includegraphics[width = \textwidth]{figures/define_identify}

\end{frame}

\begin{frame}{We learned to define and identify causal effects}

We learned about DAGs
\begin{itemize}
\item Nodes and paths
\item Structures
$$
\begin{aligned}
&\text{Causal path} \qquad&& \bullet\rightarrow\bullet\rightarrow\bullet \\
&\text{Fork} \qquad&& \bullet\leftarrow\bullet\rightarrow\bullet \\
&\text{Collider} \qquad&& \bullet\rightarrow\bullet\leftarrow\bullet
\end{aligned}
$$
\item Selecting a sufficient adjustment set
\end{itemize}

\end{frame}

\begin{frame}{We learned models for description}
...
\begin{frame}{We learned models for causal inference}
...
\begin{frame}{We learned about matching}
\includegraphics[width = \textwidth]{figures/matched_visual}
\end{frame}

\begin{frame}{We learned about trees}
\includegraphics[width = \textwidth]{figures/tree_visual}
\end{frame}

\begin{frame}

We learned lots of ways to predict $Y$\\
given a set of predictors $\vec{X}$ \vskip .2in
(supervised machine learning)

\end{frame}

\begin{frame}{You put it all together in a project}
\pause

You got data \vskip .2in
\includegraphics[width = \textwidth]{figures/ipums_register_1.png} \pause \vskip .2in

\begin{itemize}
\item You visualized your findings
\item You answered a descriptive and causal question
\item You presented what you found!
\end{itemize}
...
\large 
\begin{enumerate}
\item What is your favorite thing you learned this quarter? \pause
\item What worked especially well in the course structure / topics? \pause
...
\item Especially specific experiences with your TA
\end{itemize}

\end{frame}

\begin{frame}
\huge Thank you for a great quarter! \vskip .2in
\includegraphics{figures/eval_qr}
\end{frame}
