...
4) Choose an outcome variable, which is defined for each unit in the population. Your outcome variable can be a factual variable ($Y$) for descriptive claims, or a potential outcome ($Y^a$) or difference in potential outcomes ($Y^1-Y^0$) for causal claims.
